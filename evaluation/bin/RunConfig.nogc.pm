...
@gcconfigs = (
		...
		"jdk-mmtk-32bit-1x|ms|s|c2|tph",
		"jdk-mmtk-32bit-2x|ms|s|c2|tph",
		"jdk-mmtk-32bit-4x|ms|s|c2|tph",
		"jdk-mmtk-64bit-1x|ms|s|c2|tph",
		"jdk-mmtk-64bit-2x|ms|s|c2|tph",
		"jdk-mmtk-64bit-4x|ms|s|c2|tph",
	    "jdk-mmtk-64bit|ms|s|c2|epsilon",
);
...
%jvmroot = (
        ...
        "jdk-mmtk-32bit-1x" => "$rootdir/build/jdk-mmtk-32bit-1x",
        "jdk-mmtk-32bit-2x" => "$rootdir/build/jdk-mmtk-32bit-2x",
        "jdk-mmtk-32bit-4x" => "$rootdir/build/jdk-mmtk-32bit-4x",
