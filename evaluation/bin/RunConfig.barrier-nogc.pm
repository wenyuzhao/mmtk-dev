...
# configurations
@gcconfigs = (
	"jdk-mmtk-nogc-no-barrier|ms|s|c2|tph",
	"jdk-mmtk-nogc-barrier|ms|s|c2|tph",
	"jdk-mmtk-nogc-barrier-fastonly|ms|s|c2|tph",
	"jdk-mmtk-nogc-barrier-takerate|ms|s|c2|tph",
	"jdk-mmtk-nogc-barrier-testglobal|ms|s|c2|tph",
	# "jdk-mmtk-nogc-no-barrier|ms|s|c2|epsilon",
	# "jdk-mmtk-nogc-barrier-single-page-metadata|ms|s|c2|tph",
	# "jdk-mmtk-nogc-barrier-test-global|ms|s|c2|tph",
	# "jdk-mmtk-nogc-barrier-fast-no-slowcall|ms|s|c2|tph",
	# "jdk-mmtk-nogc-barrier-fast-nop-slowcall|ms|s|c2|tph",
	# "jdk-mmtk-nogc-barrier-fast-slowcall-flipbit|ms|s|c2|tph",
);
