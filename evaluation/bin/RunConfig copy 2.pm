...
%booleanopts = (
		...
		"tph" => "-XX:+UseThirdPartyHeap",
			...
			"epsilon" => "-XX:-UseCompressedOops -XX:+UnlockExperimentalVMOptions -XX:+UseEpsilonGC -XX:-EpsilonElasticTLAB -XX:TLABSize=32K -XX:-ResizeTLAB",
...
# configurations
@gcconfigs = (
	    #   "jdk-mmtk-32bit|ms|s|c2|tph",
	    #   "jdk-mmtk-64bit|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc1|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc1-2x-lab|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc1-4x-lab|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc1-8x-lab|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc2|ms|s|c2|tph",
		"jdk-mmtk-64bit-nogc3|ms|s|c2|tph",
		# "jdk-mmtk-64bit-4x|ms|s|c2|tph",
	      "jdk-mmtk-64bit-nogc1|ms|s|c2|epsilon",
	      );


# directories in which productio jvms can be found
%jvmroot = (
        # "jdk-mmtk-64bit-nogc1" => "$rootdir/build/jdk-mmtk-64bit-nogc1",
        # "jdk-mmtk-64bit-nogc2" => "$rootdir/build/jdk-mmtk-64bit-nogc2",
        # "jdk-mmtk-64bit-nogc3" => "$rootdir/build/jdk-mmtk-64bit-nogc3",
        # "jdk-mmtk-32bit" => "$rootdir/build/jdk-mmtk-32bit",
        # "jdk-mmtk-64bit" => "$rootdir/build/jdk-mmtk-64bit",
        # "jdk-mmtk-64bit-1x" => "$rootdir/build/jdk-mmtk-64bit-1x",
        # "jdk-mmtk-64bit-2x" => "$rootdir/build/jdk-mmtk-64bit-2x",
        # "jdk-mmtk-64bit-4x" => "$rootdir/build/jdk-mmtk-64bit-4x",
        # "jdk-mmtk-fastalloc" => "$rootdir/build/jdk-mmtk-fastalloc",
        # "jdk-mmtk-slowalloc" => "$rootdir/build/jdk-mmtk-slowalloc",
        # "jdk-mmtk-fastalloc2" => "$rootdir/build/jdk-mmtk-fastalloc2",
        # "jdk-mmtk-slowalloc2" => "$rootdir/build/jdk-mmtk-slowalloc2",
	    );
