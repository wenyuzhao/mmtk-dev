...
%envopts = (
	"ss" => "MMTK_PLAN=SemiSpace",
	"ix" => "MMTK_PLAN=Immix",
);

# configurations
@gcconfigs = (
	"jdk-mmtk-immix-defrag|ms|s|c2|tph|ss",
	"jdk-mmtk-immix-blockonly|ms|s|c2|tph|ix",
	"jdk-mmtk-immix-nonmove|ms|s|c2|tph|ix",
	"jdk-mmtk-immix-defrag|ms|s|c2|tph|ix",
);
...
# @dacapo_9_12 = ("avrora", "fop", "h2", "jython", "luindex", "pmd", "sunflow", "tradebeans", "xalan");
@dacapo_9_12 = ("avrora", "fop", "jython", "luindex", "pmd", "sunflow", "xalan");
@dacapo_2006 = ("antlr", "chart", "eclipse", "hsqldb");

@benchmarks = (@dacapo_9_12, @dacapo_2006);
# @benchmarks = ("fop", "sunflow", "tradebeans", "xalan");
