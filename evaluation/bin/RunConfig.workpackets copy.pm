...
# configurations
@gcconfigs = (
	"jdk-work-packets|ms|s|c2|tph",
	"jdk-baseline|ms|s|c2|tph",
	"jdk-work-packets-stress|ms|s|c2|tph",
	"jdk-baseline-stress|ms|s|c2|tph",
);
...
@dacapo_9_12 = ("fop", "luindex", "lusearch-fix", "pmd", "sunflow", "xalan", "avrora", "jython");
@dacapo_2006 = ("antlr", "chart", "eclipse");
...
%bmargs = (
	   ...
	   "dacapobach" => "-Dprobes=MMTk -cp $rootdir/../probes/probes.jar:$benchmarkroot/dacapo/dacapo-9.12-MR1-bach-java6.jar Harness -n [#] [bm]",
