...
# running runbms ./evaluation/results/log ~/MMTk-Dev/evaluation/configs/lxr-shepherd-pauses/config.2x.lu.yml 12 7 &> ~/_log

running runbms ./evaluation/results/log /home/wenyuz/MMTk-Dev/evaluation/configs/lxr-shepherd-latency/config.2x.lu.yml 12 7 &>> ~/_log

running runbms ./evaluation/results/log /home/wenyuz/MMTk-Dev/evaluation/configs/lxr-shepherd-latency/config.2x.other.yml 12 7 &>> ~/_log
