...
# New GC trigger
# build_one jdk-lxr-new-trigger-2-$branch lxr,lxr_heap_health_guided_gc
# build_one jdk-lxr-new-trigger-2-256-$branch lxr,lxr_heap_health_guided_gc,mmtk/lxr_buf_256
# build_one jdk-lxr-new-trigger-2-512-$branch lxr,lxr_heap_health_guided_gc,mmtk/lxr_buf_512
# build_one jdk-lxr-new-trigger-2-2048-$branch lxr,lxr_heap_health_guided_gc,mmtk/lxr_buf_2048

# build_one jdk-lxr-new-trigger-2-nometa-$branch lxr,lxr_heap_health_guided_gc,mmtk/no_meta_counting
