...
rake jdk:test gc=Immix heap=20G   noc1=1 bench=lusearch n=5 profile=release features=lxr,lxr_heap_health_guided_gc,mmtk/lxr_incremental_defrag,mmtk/lxr_region_4m SIMPLE_INCREMENTAL_DEFRAG=8 SIMPLE_INCREMENTAL_DEFRAG_MULTIPLIER=8 NURSERY_BLOCKS=8192
