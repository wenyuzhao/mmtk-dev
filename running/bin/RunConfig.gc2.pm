...
@gcconfigs = (
	      ...
	      # "jrmc-1.6.0|s",
			...
			# "FastAdaptiveG1SATBSlow|s|wr|p-1",
...
@all_dacapo_bachmarks = (
	...
	"avrora", "jython", "sunflow", 
	"antlr"#, "eclipse"
	# "batik", "chart", "eclipse", "tomcat", "tradebeans", "tradesoap",
);
@benchmarks = (@all_dacapo_bachmarks, @jvm98bms);
# @benchmarks = ("_213_javac");
